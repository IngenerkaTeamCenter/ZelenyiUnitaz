...
void zapolnenie_menu()
{
    ...
    knopki_dlya_menu[4] = {4*SHIRINA_KNOPKI, 0, "iPod_nano_6", -1, txLoadImage ("Icons\\iPod_nano_6.bmp")};
    ...
    y = 0;
    knopki_dlya_menu[1].knopki[0] = {SHIRINA_KNOPKI,   y, "tv", -1, txLoadImage ("Icons\\tv.bmp")};
